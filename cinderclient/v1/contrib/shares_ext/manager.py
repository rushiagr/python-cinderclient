...
class ShareManager(base.ManagerWithFind):
    ...
    def create(self, share_proto, size, snapshot_id=None, display_name=None,
        ...
        :param display_name: Name of the NAS
    ...
    def list(self, detailed=True):
        ...
        """
        if detailed is True:
            return self._list("/shares/detail", "shares")
        else:
            return self._list("/shares", "shares")
